...
def generate_raw_dataset_with_collector(args):
    """
    Generates a Minari dataset with RAW observations by using a separate,
    identically configured "expert_env" to generate actions.
    """
    ...
    print(collector_env.observation_space)
    ...
    raw_obs, _ = collector_env.reset(seed=args.seed)
    ...
    # )
    # print(f"\nDataset '{dataset_id}' with raw observations created successfully!")
