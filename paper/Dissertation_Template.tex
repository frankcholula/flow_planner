...
\begin{document}
\normalsize
\rhead{\textcolor{ashgrey}{Frank Tsu-Fang Lu, MSc dissertation}}
\renewcommand{\headrulewidth}{0pt}
%%%%%%%%%%%%%%%%%COVER PAGE%%%%%%%%%%%%%%%%%
%\thispagestyle{empty}
\begin{center}
{\LARGE {\vspace*{0.5cm}\Huge\bf Planning Fast and Slow: Guided Trajectory Synthesis via Conditional Flow Matching}}

\vspace{3em}
        {\Large \bf Frank Tsu-Fang Lu}\\
        \vspace{2em}
        {\Large\textit{Master of Science in Computer Vision, Robotics and Machine Learning}\\
        from the\\
       ...
       Supervised by: Dr. Simon Hadfield\\
        \vspace{\stretch{1}}}
        \textcopyright Frank Tsu-Fang Lu 2025
\end{center}
\pagenumbering{roman}
